...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('menu', '0013_submenuitem_title_of_submenu'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='menu',
            field=modelcluster.fields.ParentalKey(help_text='Menu to which this item belongs', on_delete=django.db.models.deletion.CASCADE, related_name='sub_menu_items', to='menu.menu'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', modelcluster.fields.ParentalKey(help_text='Menu to which this item belongs', on_delete=django.db.models.deletion.CASCADE, related_name='link_menu_items', to='menu.menu')),
            ],
            options={
